...
<body id="page-top" class="index"
	style="background-image: url('img/library1.jpg'); background-attachment: fixed;">
	...
	<div class="row">
		...
		<div class="col-sm-8">
			<div class="jumbotron"
				...
				<h4>Details Required to Generate the
				...
				<form role="form" action="view_timetable" method="post" name="form"
					...
					<div class="form-group">
						<label for="break">Insert Break (skip
					...
					<div class="form-group">
						<label for="noteachers">Subjects Assigned to Faculties:</label> <input
				...
				<span
					...
					href="view-timetable"><i>Testing Phase
